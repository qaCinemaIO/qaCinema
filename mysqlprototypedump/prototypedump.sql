...
CREATE TABLE `movies` (
  ...
  KEY `genre_key_idx` (`fk_genre_id`),
  CONSTRAINT `genre_key` FOREIGN KEY (`fk_genre_id`) REFERENCES `genres` (`idgenres`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `screenings` (
  `idscreenings` int NOT NULL,
  `fk_movie_id` int DEFAULT NULL,
  `fk_screen_id` int DEFAULT NULL,
  `date_time` datetime DEFAULT NULL,
  PRIMARY KEY (`idscreenings`),
  KEY `movie to time_idx` (`fk_movie_id`),
  KEY `screen_to_time_idx` (`fk_screen_id`),
  CONSTRAINT `movie_to_time` FOREIGN KEY (`fk_movie_id`) REFERENCES `movies` (`idMovies`),
  CONSTRAINT `screen_to_time` FOREIGN KEY (`fk_screen_id`) REFERENCES `screens` (`idscreens`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `screens` (
  `idscreens` int NOT NULL,
  `fk_cinema_id` int NOT NULL,
  `no_seats` int NOT NULL,
  PRIMARY KEY (`idscreens`),
  KEY `screens_to_cinemas_idx` (`fk_cinema_id`),
  CONSTRAINT `screens_to_cinemas` FOREIGN KEY (`fk_cinema_id`) REFERENCES `cinemas` (`idcinemas`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2020-08-27 11:57:23
